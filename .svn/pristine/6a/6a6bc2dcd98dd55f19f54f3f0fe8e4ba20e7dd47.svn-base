/*
 *  Sudo Slider ver 2.1.8 - jQuery plugin 
	...
	$.fn.sudoSlider = function(optionsOrg)
	{
		...
		return this.each(function()
		{
			...
			function adjustPosition() // hÃ¸ns
			{
				...
				// This next line fixes a bug that IE8 moved all the slides 1px to the right. I found out that all slides to the left of the viewable area was measured correctly, so i move everything there before calculating where to go.  // hÃ¸ns
